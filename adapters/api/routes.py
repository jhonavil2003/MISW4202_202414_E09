...
from adapters.api.controllers import PermisosController, UserController ,RolesController, UserRolesController, GestorController
...
def register_routes(api: Api):
    ...
    api.add_resource(GestorController, '/gestor', '/gestor/<int:user_id>')